...
describe('Circular Dependencies', () => {
  ...
  describe('edge cases', () => {
    ...
    it('Should handle a financial model with circular data', () => {
      ...
      expect(hfInstance.getCellValue(adr('CZ9', hfInstance.getSheetId('Summary')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DA9', hfInstance.getSheetId('Summary')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DB9', hfInstance.getSheetId('Summary')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DC9', hfInstance.getSheetId('Summary')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DD8', hfInstance.getSheetId('Summary')))).toBe(0)
      expect(hfInstance.getCellValue(adr('CZ8', hfInstance.getSheetId('IS')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DA8', hfInstance.getSheetId('IS')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DB8', hfInstance.getSheetId('IS')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DC8', hfInstance.getSheetId('IS')))).toBe(0)
      expect(hfInstance.getCellValue(adr('CZ169', hfInstance.getSheetId('Consumer')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DA169', hfInstance.getSheetId('Consumer')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DB169', hfInstance.getSheetId('Consumer')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DC169', hfInstance.getSheetId('Consumer')))).toBe(0)
      expect(hfInstance.getCellValue(adr('CZ131', hfInstance.getSheetId('Business')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DA131', hfInstance.getSheetId('Business')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DB131', hfInstance.getSheetId('Business')))).toBe(0)
      expect(hfInstance.getCellValue(adr('DC131', hfInstance.getSheetId('Business')))).toBe(0)
    })
  })
})
